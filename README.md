...
- **Center** — **Trajectory**: 3D scene (Plotly.js) with Earth, path, debris; obstacle count; **debris popup** (size, material, type, trajectory; **ARDUINO LIVE** — distance, magnetic field, temperature when data is available)
