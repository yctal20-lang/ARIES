...
> **Важно:** демо работает на бесплатном тарифе Render. После 10–15 минут без активности сервис уходит в спящий режим. Первый запрос после этого может занять 30–60 секунд на пробуждение — дальше всё будет работать быстро.
