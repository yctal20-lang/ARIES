...
> **Важно:** Бесплатный инстанс Render уходит в спящий режим после ~15 минут бездействия. Первый запрос после этого может занять 30–60 секунд на пробуждение. Для развёртывания собственного инстанса необходим [аккаунт Render](https://render.com).
